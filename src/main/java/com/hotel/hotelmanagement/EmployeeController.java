...
public class EmployeeController implements Initializable {
    ...
    public void handleExportAction(javafx.event.ActionEvent actionEvent) throws IOException {
        Stage update = new Stage();
        Parent root = FXMLLoader.load(getClass().getResource("exportemployee.fxml"));
        Scene scene = new Scene(root);
        update.setScene(scene);
        update.show();
    }
